...
(function (ca) {
    ...
    function ea(b) { if (!b)
        return b; var c = ca; v(b.split("."), function (b) { c = c[b]; }); return c; }
    ...
    function ha(b) {
        ...
        function d(a) { z && v(document.getElementsByTagName("script"), function (e) { if (e.getAttribute("data-requiremodule") === a && e.getAttribute("data-requirecontext") === i.contextName)
            return e.parentNode.removeChild(e), !0; }); }
        function g(a) { var e = j(l.paths, a); if (e && H(e) && 1 < e.length)
        ...
        function r(a, e, b) { var f = a.id, n = j(k, f); if (s(p, f) && (!n || n.defineEmitComplete))
            "defined" === e && b(p[f]);
        else if (n = q(a), n.error && "error" === e)
            b(n.error);
        else
            n.on(e, b); }
        function w(a, e) { var b = a.requireModules, f = !1; if (e)
            e(a);
        else if (v(b, function (e) { if (e = j(k, e))
            e.error = a, e.events.error && (f = !0, e.emit("error", a)); }), !f)
            h.onError(a); }
        function x() { S.length && (ia.apply(A, [A.length, 0].concat(S)), S = []); }
        function y(a) { delete k[a]; delete W[a]; }
        function F(a, e, b) {
            var f = a.map.id;
        ...
        function D() {
            ...
            if (!X) {
                X = !0;
                B(W, function (a) { var i = a.map, m = i.id; if (a.enabled && (i.isDefine || c.push(a), !a.error))
                    if (!a.inited && b)
                ...
                if ((!b || e) && h)
                    if ((z || fa) && !Y)
                        Y = setTimeout(function () { Y = 0; D(); }, 50);
                X = !1;
            }
        }
        function E(a) { s(p, a[0]) || q(m(a[0], null, !0)).init(a[1], a[2]); }
        function K(a) { var a = a.currentTarget || a.srcElement, e = i.onScriptLoad; a.detachEvent && !Z ? a.detachEvent("onreadystatechange", e) : a.removeEventListener("load", e, !1); e = i.onScriptError; (!a.detachEvent || Z) && a.removeEventListener("error", e, !1); return { node: a, id: a && a.getAttribute("data-requiremodule") }; }
        function L() {
            var a;
            for (x(); A.length;) {
                a = A.shift();
        ...
        N = { require: function (a) { return a.require ? a.require : a.require = i.makeRequire(a.map); }, exports: function (a) { a.usingExports = !0; if (a.map.isDefine)
                return a.exports ? p[a.map.id] = a.exports : a.exports = p[a.map.id] = {}; }, module: function (a) {
                return a.module ?
                    a.module : a.module = { id: a.map.id, uri: a.map.url, config: function () { return j(l.config, a.map.id) || {}; }, exports: a.exports || (a.exports = {}) };
            } };
        $ = function (a) { this.events = j(aa, a.id) || {}; this.map = a; this.shim = j(l.shim, a.id); this.depExports = []; this.depMaps = []; this.depMatched = []; this.pluginMaps = {}; this.depCount = 0; };
        $.prototype = { init: function (a, e, b, f) {
                ...
                if (!this.inited) {
                    ...
                    if (b)
                        ...
                        this.events.error && (b = t(this, function (a) { this.emit("error", a); }));
            ...
            }, defineDep: function (a, e) { this.depMatched[a] || (this.depMatched[a] = !0, this.depCount -= 1, this.depExports[a] = e); }, fetch: function () { if (!this.fetched) {
                this.fetched = !0;
                i.startTime = (new Date).getTime();
                var a = this.map;
                if (this.shim)
                    i.makeRequire(this.map, { enableBuildCallback: !0 })(this.shim.deps || [], t(this, function () { return a.prefix ? this.callPlugin() : this.load(); }));
                else
                    ...
                    if (this.map.unnormalized) {
                        if (f.normalize && (J = f.normalize(J, function (a) { return c(a, u, !0); }) || ""), f = m(a.prefix + "!" + J, this.map.parentMap), r(f, "defined", t(this, function (a) { this.init([], function () { return a; }, null, { enabled: !0, ignore: !0 }); })), g = j(k, f.id)) {
                            ...
                            if (this.events.error)
                                g.on("error", t(this, function (a) { this.emit("error", a); }));
                            g.enable();
                        }
                    }
                    else
                        g ? (this.map.url = i.nameToUrl(g), this.load()) : (d = t(this, function (a) { this.init([], function () { return a; }, null, { enabled: !0 }); }), d.error = t(this, function (a) { this.inited = !0; this.error = a; a.requireModules = [b]; B(k, function (a) { 0 === a.map.id.indexOf(b + "_unnormalized") && y(a.map.id); }); w(a); }), d.fromText = t(this, function (f, c) {
                ...
                B(this.pluginMaps, t(this, function (a) { var b = j(k, a.id); b && !b.enabled && i.enable(a, this); }));
                this.enabling = !1;
                this.check();
        ...
        i = { config: l, contextName: b, registry: k, defined: p, urlFetched: T, defQueue: A, Module: $, makeModuleMap: m,
            nextTick: h.nextTick, onError: w, configure: function (a) {
                ...
                a.shim && (B(a.shim, function (a, c) { H(a) && (a = { deps: a }); if ((a.exports || a.init) && !a.exportsFn)
                    a.exportsFn = i.makeShimExports(a); b[c] = a; }), l.shim = b);
                ...
                function g(f, c, d) {
                    ...
                    L();
                    i.nextTick(function () { L(); l = q(m(null, a)); l.skipMap = e.skipMap; l.init(f, c, d, { enabled: !0 }); D(); });
                    return g;
                }
                e = e || {};
                ...
                a || (g.undef = function (b) { x(); var c = m(b, a, !0), e = j(k, b); d(b); delete p[b]; delete T[c.url]; delete aa[b]; U(A, function (a, c) { a[0] === b && A.splice(c, 1); }); e && (e.events.defined && (aa[b] = e.events), y(b)); });
                return g;
            ...
            }, load: function (a, b) { h.load(i, a, b); }, execCb: function (a, b, c, d) { return b.apply(d, c); }, onScriptLoad: function (a) { if ("load" === a.type || ka.test((a.currentTarget || a.srcElement).readyState))
                P = null, a = K(a), i.completeLoad(a.id); }, onScriptError: function (a) {
                var b = K(a);
                if (!g(b.id))
    ...
    if ("undefined" === typeof define) {
        ...
        h = requirejs = function (b, c, d, g) { var u, m = "_"; !H(b) && "string" !== typeof b && (u = b, H(c) ? (b = c, c = d, d = g) : b = []); u && u.context && (m = u.context); (g = j(F, m)) || (g = F[m] = h.s.newContext(m)); u && g.configure(u); return g.require(b, c, d); };
        ...
        define = function (b, c, d) {
            ...
            if (O) {
                if (!(g = L))
                    P && "interactive" === P.readyState || U(document.getElementsByTagName("script"), function (b) { if ("interactive" === b.readyState)
                        return P = b; }), g = P;
                g && (b ||
